        ...
        <table class="table-auto w-full">
            ...
            <tbody class="text-xs">
                ...
                >
                    ...
                    <td :class="{ 'line-through text-gray-400': task.completed }" class="border-t px-4 py-3">{{ task.title }}</td>
                    <td :class="{ 'line-through text-gray-400': task.completed }" class="border-t px-4 py-3">{{ task.ownerId === currentUser.id ? 'Me' : task.owner }}</td>
                    <td :class="{ 'line-through text-gray-400': task.completed }" class="border-t px-4 py-3">
                        <span :class="badgeClass(task)" class="text-white text-xs ml-2 px-2 rounded-full">{{ task.priority }}</span>
                    </td>
                    <td :class="{ 'line-through text-gray-400': task.completed }" class="border-t px-4 py-3">{{ task.dueDate }}</td>
                    <td class="border-t px-4 py-3">
                        <button
                            v-if="task.ownerId === currentUser.id"
